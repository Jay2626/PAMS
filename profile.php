...
<div class="w3-container w3-bar w3-light-gray w3-text-gray w3-card w3-display-container">
	...
	<h2 class="w3-bar-item">Profile</h2>
</div>
	<div class="w3-col l8">
		<!-- cover -->
		...
		background-repeat: no-repeat;"-->
			<img class="w3-image w3-circle w3-card" src="<?php if($employee['emp_user_image'] != null){echo $employee['emp_user_image'];} else{ echo '';} ?>" style="height:130px">
			<h2 class=""><?php echo $employee['emp_firstname'].' '.$employee['emp_middlename'].' '.$employee['emp_lastname']; ?></h2>
		</div>

...
<div class="w3-container w3-padding-32">
	<div class="w3-round-large w3-card w3-text-blue-gray w3-row">
		...
		<div class="w3-col l4">
			<!-- select month-->
			<div id="monthly" class="input-field w3-row" style="display:none; margin:18px 0 0 0">
				<select class="w3-col l10 w3-red" style="margin:0px">
					<option value="0" selected>August</option>
